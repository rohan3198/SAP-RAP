...
define view entity zrk_booking_cds
  as select from zrk_booking_m as Booking
  association        to parent ZRK_TRAVEL_CDS      as _Travel        on  $projection.travel_id = _Travel.travel_id
